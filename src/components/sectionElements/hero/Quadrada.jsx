    ...
    >
      <div className="relative z-10 flex w-full items-left">
        <div className="w-full text-secondary justify-evenly">
          <div className="h-[110px] phone2:h-[110px] phone3:h-[110px] tablet1:h-[120px] desktop3:h-[120px] " />{" "}
          <div className="flex flex-col-reverse gap-[40px] desktop1:flex-row desktop1:justify-between mx-auto w-[90%] max-w-[1215px] items-center pb-[64px]  desktop1:pt-[68px] desktop1:pb-[96px]">
            <div className="flex flex-col w-full desktop1:w-[50%] desktop1:mr-[20px]">
              ...
              <MotionDivDownToUp>
                <div
                  className={`flex justify-center desktop1:justify-start font-bold leading-[30px] phone3:leading-[32px] tablet1:leading-[40px] desktop1:leading-[30px] desktop2:leading-[30px] text-center desktop1:text-left text-title2 phone2:text-title2 phone3:text-title2 tablet1:text-title2 ${titleColor}`}
                >
